...
const inputClass =
  'rounded-lg block p-2 w-full text-sm text-grayText bg-transparent border border-graySelect appearance-none dark:text-grayText dark:border-graySelect dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer'

const labelClass =
  'px-2 peer-focus:font-medium absolute text-sm text-zinc-400 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-2.5 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:px-0  peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6'
